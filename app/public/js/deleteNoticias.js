const btnDelNoticias = document.querySelector('#btnDel')
...
if (document.querySelector('#btnOpenModal')) {
  btnOpenModal.forEach(btn => {
    btn.onclick = function (e) {
      ...
      const idNoticias = this.getAttribute('item')

      btnDelNoticias.onclick = function (e) {
        e.preventDefault()

        const formData = new FormData()
        formData.append('id', idNoticias)
